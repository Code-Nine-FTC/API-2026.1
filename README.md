...
|--------|--------------|-------------|--------------|----------|
| IRF01 | Alta | Como sistema, quero configurar um banco de dados geoespacial utilizando PostGIS para armazenamento de dados geográficos | 5 | 1 |
| IRF01 | Alta | Como sistema, quero ingerir dados geográficos básicos dos municípios do estado de São Paulo | 5 | 1 |
| IRF01 | Alta | Como sistema, quero padronizar sistemas de coordenadas (CRS) e geometrias para consistência dos dados | 3 | 1 |
| IRF01 | Alta | Como sistema, quero indexar espacialmente os dados para otimizar consultas geográficas | 5 | 1 |
| IRF01 | Alta | Como sistema, quero importar dados de Unidades de Conservação do ICMBio | 3 | 1 |
| IRF01 | Alta | Como sistema, quero importar dados de Terras Indígenas da FUNAI | 3 | 1 |
| IRF01 | Alta | Como sistema, quero importar dados de queimadas do INPE | 3 | 1 |
| IRF01 | Alta | Como sistema, quero importar dados de assentamentos rurais do INCRA | 3 | 1 |
| IRF01 | Alta | Como sistema, quero importar dados de territórios quilombolas da Fundação Palmares | 3 | 1 |
| IRF01 | Alta | Como sistema, quero integrar dados estaduais provenientes do DataGeo SP | 3 | 1 |
...
| IRF03 | Alta | Como sistema, quero detectar interseção entre imóveis rurais e unidades de conservação | 5 | 2 |
| IRF03 | Alta | Como sistema, quero detectar proximidade entre imóveis e áreas de queimadas | 5 | 2 |
| IRF03 | Alta | Como sistema, quero calcular áreas sobrepostas entre entidades geográficas | 5 | 2 |
| IRF04 | Alta | Como sistema, quero interpretar perguntas simples feitas pelo usuário | 3 | 2 |
| IRF04 | Alta | Como sistema, quero mapear a intenção do usuário em consultas semânticas | 5 | 2 |
| IRF04 | Alta | Como sistema, quero extrair entidades geográficas (como município) das perguntas | 5 | 2 |
| IRF04 | Alta | Como sistema, quero converter perguntas em consultas SQL automaticamente | 5 | 2 |
| IRF05 | Alta | Como sistema, quero registrar a fonte de dados utilizada nas respostas | 3 | 2 |
...
| IRF06 | Média | Como sistema, quero conectar o banco PostGIS ao QGIS para visualização | 3 | 3 |
| IRF06 | Média | Como sistema, quero publicar serviços WMS/WFS para consumo geoespacial | 5 | 3 |
| IRF06 | Média | Como sistema, quero disponibilizar um projeto configurado no QGIS | 3 | 3 |
| IRF06 | Média | Como sistema, quero otimizar consultas com índices espaciais avançados | 5 | 3 |
| IRF06 | Média | Como sistema, quero implementar cache de consultas para melhorar performance | 5 | 3 |
| IRF06 | Média | Como sistema, quero reduzir o tempo de resposta das APIs geoespaciais | 5 | 3 |
...
| :------: | :------: | :------: | :------: | :------: |
| <img src="https://avatars.githubusercontent.com/u/142221456?v=4" height="64px"> | Pedro Oliveira | Product Owner | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/79583088?v=4" height="64px"> | Yuri Braga | Scrum Master | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/104574671?v=4" height="64px"> | Davi Maciel | Developer | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/142128061?v=4" height="64px"> | Eber Júnior | Developer | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/61799878?v=4" height="64px"> | Elisa Rachel | Developer | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/142221848?v=4" height="64px"> | Jonas Miguel | Developer | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/142221695?v=4" height="64px"> | Joyce Silva | Developer | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/142221388?v=4" height="64px"> | Júlia Rosado | Developer | GitHub | LinkedIn |
| <img src="https://avatars.githubusercontent.com/u/142221532?v=4" height="64px"> | Renato Cruz | Developer | GitHub | LinkedIn |
